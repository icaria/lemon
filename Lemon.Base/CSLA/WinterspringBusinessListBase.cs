...
namespace Lemon.Base
{
        ...
        where C : class, IEditableBusinessObject
    {
        ...
        public new System.Threading.Tasks.Task<T> SaveAsync()
        {
        ...
        public void SwapItem(int index1, int index2)
        {
            ...
            var wasDeleted1 = DeletedList.Contains(item1);
            var wasDeleted2 = DeletedList.Contains(item2);
            ...
            //In at least one version of CSLA, the setters above would trigger the replaced item to be deleted.
            //Ensure that they don't end up deleted later unless they were already deleted.
            if(!wasDeleted1)
                DeletedList.Remove(item1);
            if (!wasDeleted2)
