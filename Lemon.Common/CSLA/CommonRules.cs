...
//Taken from http://cslacontrib.codeplex.com/SourceControl/changeset/view/92754#1603402
...
namespace Lemon.CommonRules
{
    ...
    public class LessThan : CommonBusinessRule
    {
        ...
        protected override string ErrorMessage
        {
            get
            {
                return HasErrorMessageDelegate ? base.ErrorMessage : "{0} must be less than {1}";
            }
        }
    ...
    public class LessThanOrEqual : CommonBusinessRule
    {
        ...
        protected override string ErrorMessage
        {
            get
            {
                return HasErrorMessageDelegate ? base.ErrorMessage : "{0} must be less than or equal to {1}";
            }
        }
    ...
    public class GreaterThan : CommonBusinessRule
    {
        ...
        protected override string ErrorMessage
        {
            get
            {
                return HasErrorMessageDelegate ? base.ErrorMessage : "{0} must be greater than {1}";
            }
        }
    ...
    public class GreaterThanOrEqual : CommonBusinessRule
    {
        ...
        protected override string ErrorMessage
        {
            get
            {
                return HasErrorMessageDelegate ? base.ErrorMessage : "{0} must be greater than or equal to {1}";
            }
        }
    ...
    public class Range : CommonBusinessRule
    {
        ...
        protected override string ErrorMessage
        {
            get
            {
                return HasErrorMessageDelegate ? base.ErrorMessage : "{0} must be between {1} and {2}";
            }
        }
    ...
    public class AnyRequired : CommonBusinessRule
    {
        ...
        protected override string ErrorMessage
        {
            get
            {
                return HasErrorMessageDelegate ? base.ErrorMessage : "At least on of the fields {0} must have a value";
            }
        }
