...
namespace Lemon.Model
{
    ...
    public partial class AccountList : BusinessListBase<AccountList, Account>
    {
        ...
        /// <returns>A <see cref="AccountList"/> object of the specified criteria.</returns>
        internal static AccountList GetByCategoryId(System.Int32 categoryId)
        {
        ...
        internal static async Task<AccountList> GetByCategoryIdAsync(System.Int32 categoryId)
        {
            var criteria = new AccountCriteria{CategoryId = categoryId};
        ...
        {
            Account item = Lemon.Model.Account.NewAccount();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = Lemon.Model.Account.NewAccount();
        ...
        {
            return await Lemon.Model.Account.NewAccountAsync().ContinueWith(t => 
            {
        ...
        {
            return Lemon.Model.Account.Exists(criteria);
        }
        /// <summary>
        /// Determines if a record exists in the Account in the database for the specified criteria. 
        /// </summary>
