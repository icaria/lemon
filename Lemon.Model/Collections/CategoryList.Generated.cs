...
namespace Lemon.Model
{
    ...
    public partial class CategoryList : BusinessListBase<CategoryList, Category>
    {
        ...
        internal static CategoryList GetByCategoryId(System.Int32 categoryId)
        {
        ...
        internal static async Task<CategoryList> NewListAsync()
        {
            return await DataPortal.CreateAsync<CategoryList>();
        }

        internal static async Task<CategoryList> GetByCategoryIdAsync(System.Int32 categoryId)
        {
            var criteria = new CategoryCriteria{CategoryId = categoryId};
            
            
            return await DataPortal.FetchAsync<AsyncChildLoader<CategoryList>>(criteria).ContinueWith(t => t.Result.Child);
        }

        internal static async Task<CategoryList> GetByCriteriaAsync(CategoryCriteria criteria)
        {  
            return await DataPortal.FetchAsync<AsyncChildLoader<CategoryList>>(criteria).ContinueWith(t => t.Result.Child);
        }

        internal static async Task<CategoryList> GetAllAsync()
        {
            return await DataPortal.FetchAsync<AsyncChildLoader<CategoryList>>(new CategoryCriteria()).ContinueWith(t => t.Result.Child);
        }
        ...
        {
            Category item = Lemon.Model.Category.NewCategory();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = Lemon.Model.Category.NewCategory();
        ...
        protected async Task<Category> AddNewCoreAsync()
        {
            return await Lemon.Model.Category.NewCategoryAsync().ContinueWith(t => 
            {
                 Category item = t.Result;
        ...
        {
            return Lemon.Model.Category.Exists(criteria);
        }
        /// <summary>
        /// Determines if a record exists in the Category in the database for the specified criteria. 
        /// </summary>
        ...
        public bool Contains(System.Int32 categoryId)
        {
            return this.Count(i => i.CategoryId == categoryId) > 0;
        }
 
        public bool ContainsDeleted(System.Int32 categoryId)
        {
            return DeletedList.Count(i => i.CategoryId == categoryId) > 0;
        }
        
        public void Remove(System.Int32 categoryId)
        {
