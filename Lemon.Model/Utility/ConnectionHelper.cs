    ...
    public static class ConnectionHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                ...
                {
                    _connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["LemonConnectionString"].ConnectionString;
                }
        ...
        {
            string prefix = includePrefix ? "@_" : String.Empty;
        ...
        public static string BuildWhereStatement(Dictionary<string, object> bag)
        {
            ...
            string columnNames = bag.Keys.Aggregate(String.Empty, (current, columnName) => current + String.Format("[{0}] = @_{0} AND ", columnName));
